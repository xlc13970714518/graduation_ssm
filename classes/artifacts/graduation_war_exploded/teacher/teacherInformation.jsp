      ...
      <nav class="navbar navbar-default">
        <div class="topbar">
          ...
          <div class="topbar-left">
            ...
            <span class="navbar-page-title"> 教师功能 --个人信息 </span>
          </div>
          ...
          <ul class="topbar-right">
            <li class="dropdown dropdown-profile">
              <a href="javascript:void(0)" data-toggle="dropdown">
                ...
                <span>学生 ：${sessionScope.teacher.getName()}<span class="caret"></span></span>
              </a>
              ...
              <div class="card-body">
                <form method="post" action="#!" class="layui-form">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="position" id="position" readonly="true" style="width:400px"/>
                  </div>
                 <div class="form-group">
...
$(function(){
	$.post("../teacherInformation",function(result){
		var teacher=result['teacher'];
	    $("#username").val(teacher.name);
		$("#number").val(teacher.num);
		$("#position").val(teacher.position);
		$("#phonenumber").val(teacher.phonenumber);
		$("#qq").val(teacher.qq);
		});
	});
updateTeacher=function(){
	...
	var qq=$("#qq").val();
	$.post("../updateTeacher",{"num":num,"name":name,"position":position,"phonenumber":phonenumber,"qq":qq},function(flag){
	if(flag=="true"){
			alert("保存成功！");
